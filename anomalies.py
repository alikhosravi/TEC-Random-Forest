...
'''
#AU
axes[5].axes.plot(A_Times,AU_Values,'o')
axes[5].set_xticks(np.linspace(S_DOY,E_DOY,(E_DOY-S_DOY+1)))

#AL
axes[6].axes.plot(A_Times,AL_Values,'o')
axes[6].set_xticks(np.linspace(S_DOY,E_DOY,(E_DOY-S_DOY+1)))

#AO
axes[7].axes.plot(A_Times,AO_Values,'o')
axes[7].set_xticks(np.linspace(S_DOY,E_DOY,(E_DOY-S_DOY+1)))
'''
